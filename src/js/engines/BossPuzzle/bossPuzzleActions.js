...
export const initFrame = (imgNumbers:Array<number>, imgIndex:number, tiles:Array<number>, hiddenTileCoords:Coords) => ({
  type: INIT_FRAME,
  payload: {
...
export const switchTiles = (index1:number, index2:number, hiddenTileCoords:Coords) => ({
  type: SWITCH_TILES,
  meta: {
    index1: index1,
    index2: index2
