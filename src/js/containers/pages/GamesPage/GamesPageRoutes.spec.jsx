...
import {
  ...
  gameCategoriesRes,
  gamesRes,
} from "js/helpers/apiResponses";
import { renderWrapper } from "js/helpers/testUtils";
...
describe("GamesPage", () => {
  describe("/games", () => {
    ...
    it("should redirect", () => {
      ...
      expect(
        wrapper.find('[pathname="/games/sliding/boss-puzzle"]').length,
      ).toBe(1);
    ...
    it("should redirect", () => {
      ...
      const wrapper = renderWrapper(
        ["/games/sliding/boss-puzzle?mode=ABC&dimension=-1"],
        0,
      );
      expect(
        wrapper.find('[pathname="/games/sliding/boss-puzzle"]').length,
    ...
    it("should render GamePage", () => {
      state.app.authStatus = "logged_in";
      const wrapper = renderWrapper(
        ["/games/sliding/boss-puzzle?mode=NUM&dimension=3"],
        0,
      );
    ...
    it("should render GamePage", () => {
      state.app.authStatus = "logged_in";
      const wrapper = renderWrapper(
        ["/games/sliding/boss-puzzle?mode=IMG&dimension=5"],
        0,
      );
      expect(wrapper.find(".GamePage").length).toBe(1);
    });
